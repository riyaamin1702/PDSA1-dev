    ...
    for i in input_files:
      with open(i,'r') as f:
        for line in f: 
            ...
            v=fields[1:14] # this mapps fields from index 1 to 14 we are skipping 0 because it is has empty 
            try:
                skipVar = v[0] # first index from list of str
            except:
                continue # at the end of the index will out of the range so this is an exception that will continue so the data wont be lost
